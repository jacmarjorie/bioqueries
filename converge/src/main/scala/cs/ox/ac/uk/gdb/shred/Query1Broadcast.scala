...
/**
  * Query1Broadcast performs query1 with broadcasted clinical data.
  */
...
object Query1Broadcast{
  ...
  var get_skew = false
  var label = "converge"
  var outfile = "/mnt/app_hdd/scratch/flint-spark/shredding_q1_bc.csv"
  var outfile2 = "/mnt/app_hdd/scratch/flint-spark/shredding_q1_bc_partitions.csv"
